...
async function runScan() {
  ...
  console.log(`🚀 FRONTEND (Vite Dev Server http://localhost:5173) -> Status: ${feRes.status} OK`);

  // 2. Backend Check
  const beRes = await fetch(`${BASE_URL}/api/cars/available`);
  console.log(`🚀 BACKEND (Spring Boot http://localhost:8081) -> Status: ${beRes.status} OK`);
  ...
  console.log('\n====================================================');
  console.log('🌟 SCAN COMPLETE: BOTH BACKEND & FRONTEND ARE 100% OPERATIONAL!');
  console.log('====================================================');
}
