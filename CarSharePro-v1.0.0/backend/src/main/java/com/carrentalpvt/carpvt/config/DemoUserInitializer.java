...
public class DemoUserInitializer implements CommandLineRunner {
    ...
    @org.springframework.beans.factory.annotation.Value("${app.init-demo-users:false}")
    ...
    public void run(String... args) {
        if (!initDemoUsers) {
            log.info("ℹ️ Demo user initialization is disabled (app.init-demo-users=false). Set APP_INIT_DEMO_USERS=true to seed demo accounts.");
            return;
        }
