...
const sampleCars = [
  ...
  },
  {
    ...
    latitude: 21.1458,
    longitude: 79.0882,
    description: 'Fast turbo sedan with ADAS Level 2, heated and ventilated front seats, and digital cluster.',
    imageUrl: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1200&q=80'
  }
];
...
async function seedDatabase() {
  ...
  try {
    ...
    console.log('\n====================================================');
    console.log(`🎉 SUCCESS: SAMPLE CARS SEEDED INTO MONGODB!`);
    console.log('====================================================');
  } catch (err) {
